...
echo -e "${YELLOW}--------------------------------------------------------"
echo -e "${YELLOW}|${BLUE} DeltaLock Development Environment ${GREEN}Successfully ${BLUE}Installed! ${YELLOW}|"
echo -e "${YELLOW}--------------------------------------------------------${NC}"

echo -e "${BLUE}You can start the rails development server by executing the command: 'rails server'. Then navigate to http://localhost:3000 in a web browser${NC}"
